...
_The Agor board during bootstrap - zones for workflow automation (left), agent's first conversation establishing identity (right)_
...
When a worktree enters the "Codex review" zone, a trigger fires automatically with a template prompt like: _"Review the PR in this worktree. Check for bugs, suggest improvements. Report findings and move to 'Human review' if changes needed."_
